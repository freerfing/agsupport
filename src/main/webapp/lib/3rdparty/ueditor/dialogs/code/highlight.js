function CLASS_HIGHLIGHT(code,syntax) 
{
    ...
    this.highlight    = function() {
        ...
        htmlTxt[htmlTxt.length] = '<span style=" text-align: right;padding:0 10px 0 0;width:100px;border-right:5px solid #ccc;margin:0 10px 0 0;">' + line_num + '.' + '</span>';
        //按分割字，分块显示
        for (var i=0; i <=word_index; i++){
            ...
            //处理换行
                ...
                line_num++;
                htmlTxt[htmlTxt.length] = ("<br/>"+'<span style="text-align: right;padding:0 10px 0 0;width:100px;border-right:5px solid #ccc;margin:0 10px 0 0;">' + line_num + '.' + '</span>');

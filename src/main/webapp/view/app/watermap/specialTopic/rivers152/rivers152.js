    ...
    function ($, app, composition, ko, common, http, panal, pager, echarts, Slick, w, mapUtils) {
	 ...
	 var title;
        var rivers_152 = {
            init: function () {
                var that = this;
                composition.addBindingHandler("riversInitHandler_152", {
                    init: function (dom) {
            ...
            initTableColumns: function () {
                ...
                w.queryMetadata("WRP_RVR_BSIN", function (columnsInfo, prikey, _metadata) {
                    ...
                    $('#riversList_152').on('rowclick', function (event) {
            ...
            getListData: function (currentPage) {
                ...
                var url = auGurit.global.rootPath + "/subject/listrivers_152";
                $.ajax({
                    type: 'POST',
        ...
        var modal = {
            ...
            clickSearchBtn: $.proxy(rivers_152.clickSearchBtn, rivers_152),
            clickResetBtn: $.proxy(rivers_152.clickResetBtn, rivers_152)
        };

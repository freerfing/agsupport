define(["jquery", "durandal/app", "durandal/composition", "knockout", "common", "http", "panal", "pager", "slickGrid", "watertype", "mapUtils", "jqxgrid.selection", "WdatePicker", "bootstrap"],
    function ($, app, composition, ko, common, http, panal, pager, Slick, w, mapUtils) {
        ...
        var PsSpoutZy = {
            init: function () {
                var that = this;
                composition.addBindingHandler("psSpoutZyInitHandler", {
                    init: function (dom) {
            ...
            initTableData: function () {
                ...
                w.queryMetadata("PS_REPORTN_PFK", function (columnsInfo, prikey, _metadata) {
                    that.initLayout();
                    $('#psSpoutZyList').on('rowclick', function (event) {
        ...
        var modal = {
            ...
            clickSearchBtn: $.proxy(PsSpoutZy.clickSearchBtn, PsSpoutZy),
            clickUnitBtn: $.proxy(PsSpoutZy.clickUnitBtn, PsSpoutZy),
            clickResetBtn: $.proxy(PsSpoutZy.clickResetBtn, PsSpoutZy),
        };

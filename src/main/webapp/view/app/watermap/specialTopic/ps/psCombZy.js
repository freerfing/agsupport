define(["jquery", "durandal/app", "durandal/composition", "knockout", "common", "http", "panal", "pager", "slickGrid", "watertype", "mapUtils", "jqxgrid.selection", "WdatePicker", "bootstrap"],
    function ($, app, composition, ko, common, http, panal, pager, Slick, w, mapUtils) {
        ...
        var PsCombZy = {
            init: function () {
                var that = this;
                composition.addBindingHandler("psCombZyInitHandler", {
                    init: function (dom) {
            ...
            initTableData: function () {
                ...
                w.queryMetadata("PS_REPORTN_YSK", function (columnsInfo, prikey, _metadata) {
                    that.initLayout();
                    $('#psCombZyList').on('rowclick', function (event) {
        ...
        var modal = {
            ...
            clickSearchBtn: $.proxy(PsCombZy.clickSearchBtn, PsCombZy),
			clickUnitBtn: $.proxy(PsCombZy.clickUnitBtn, PsCombZy),
            clickResetBtn: $.proxy(PsCombZy.clickResetBtn, PsCombZy),
        };

                ...
                childMenus: [
                    {
                        ...
                        name: "窨井",
                        parentId: "15",
                        url: "ps-well-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "雨水口",
                        parentId: "15",
                        url: "ps-comb-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "排放口",
                        parentId: "15",
                        url: "ps-spout-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "污水处理厂",
                        parentId: "15",
                        url: "ps-sewagefarm-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "排水水闸",
                        parentId: "15",
                        url: "ps-draingate-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "排水泵站",
                        parentId: "15",
                        url: "ps-pumping-station-zy-clip!list.action",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                ...
                childMenus: [
                    {
                        ...
                        name: "近期35条",
                        parentId: "9",
                        url: "slg-rv-po!list35.action?hechou35=1",//"/awater_ui_sys/heliu.html?type=1",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""
                        ...
                        name: "近期187条(含35条)",
                        parentId: "9",
                        url: "slg-rv-po!list187.action?hechou187=1",//"/awater_ui_sys/heliu.html?type=2",
                        icon: "",
                        order: "1",
                        isHeader: "0",
                        childMenus: ""

    ...
    function ($, app, composition, ko, common, http, panal, pager, echarts, Slick, w, mapUtils) {
	 ...
	 var title;
        var rivers_35 = {
            init: function () {
                var that = this;
                composition.addBindingHandler("riversInitHandler_35", {
                    init: function (dom) {
            ...
            renderUI: function () {
                ...
                modal.bshowTip(true);
                modal._$_param.maptool.showTipBar(true);
            ...
            initTableColumns: function () {
                ...
                w.queryMetadata("WRP_RVR_BSIN", function (columnsInfo, prikey, _metadata) {
                    ...
                    $('#riversList_35').on('rowclick', function (event) {
            ...
            getListData: function (currentPage) {
                ...
                var url = auGurit.global.rootPath + "/subject/listrivers_35";
                $.ajax({
                    type: 'POST',
            ...
            clickShowTipBtn: function()
            {
                 modal._$_param.maptool.showTipBar(modal.bshowTip()); 
                 return true;
            }
        }
        ...
        var modal = {
            ...
            clickSearchBtn: $.proxy(rivers_35.clickSearchBtn, rivers_35),
            clickResetBtn: $.proxy(rivers_35.clickResetBtn, rivers_35),
            clickShowTipBtn: $.proxy(rivers_35.clickShowTipBtn, rivers_35),
        };

...
define(["jquery","layer", "durandal/app", "durandal/composition", "knockout", "common", "http", "panal", "pager", "echarts", "slickGrid", "watertype", "mapUtils", "jqxgrid.selection", "WdatePicker", "bootstrap"],
	function ($,layer, app, composition, ko, common, http, panal, pager, echarts, Slick, w, mapUtils) {
		...
		var query = {
			init: function () {
				var that = this;
				composition.addBindingHandler("queryInitHandler", {
                    init: function (dom) {
            ...
            clickSearchBtn: function (wkt2) {
                ...
                try{  
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title0,slnm:slnm});                        		
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title1,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title2,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title3,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title4,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title5,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title6,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title7,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title8,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title9,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title10,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title11,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title12,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title13,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
	    		                ...
	    		                map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    		                    if(featureCollection){
	    		                    	for(var i in featureCollection.features){
	    		                    		...
	    		                    		$("#queryList").jqxGrid("addrow",null,{type:title14,slnm:slnm});
	    		                    	}
	    		                    }
	    		                });
	                        }
	    	                    ...
	    	                    map._mapInterface.queryLayerObjects(layerOption,function(featureCollection){
	    	                        if(featureCollection){
	    	                        	for(var i in featureCollection.features){
	    	                        		...
	    	                        		$("#queryList").jqxGrid("addrow",null,{type:title15,slnm:slnm});
	    	                        	}
	    	                        }
	    	                    });
	                        }
 	             ...
 	             //  });
                	...
                	console.log(e);
                	layer.alert('执行空间查询时发生异常，请联系系统管理员！', {icon: 2});
                }
            },
		...
		var modal = {
			...
			clickSearchBtn: $.proxy(query.clickSearchBtn, query),
			clickClearBtn: $.proxy(query.clickClearBtn, query)
		}
		query.init();
		return modal;
	});
            ...
            /*    	for(k in rowData) {
               	...
               	var content =  	'<div class="basic-info-row">'+
   				  				'<div class="basic-info-cell">'+
   				    				...
   				    				'<div class="basic-info-cell-content">'+rowData.czmc+'</div>'+
   				    			'</div>'+
   				    			'<div class="basic-info-cell">'+
   				    				'<div class="basic-info-cell-header">所在区域：</div>'+
   				    		...
   				    		'<div class="basic-info-row">'+
   				  				'<div class="basic-info-cell">'+
   				    				'<div class="basic-info-cell-header">测站编码：</div>'+
   				    				'<div class="basic-info-cell-content">'+rowData.czbm+'</div>'+
   				    			'</div>'+
   				    			'<div class="basic-info-cell">'+
   				    				'<div class="basic-info-cell-header">河涌名称：</div>'+
   				    				'<div class="basic-info-cell-content">'+rowData.hymc+'</div>'+
   				    			'</div>'+
   				    		'</div>'+
   				    		'<div class="basic-info-row">'+
   				  				'<div class="basic-info-cell">'+
